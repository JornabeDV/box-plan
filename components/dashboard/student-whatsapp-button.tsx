...
/**
 * Componente StudentWhatsAppButton - Botón flotante para contactar al coach por WhatsApp
 * Solo se muestra si el estudiante tiene un número de teléfono configurado 
 * y SU PLAN DE SUSCRIPCIÓN incluye WhatsApp (whatsappSupport)
 */
export function StudentWhatsAppButton({
  ...
  const { canUseWhatsAppSupport, loading } = useStudentSubscription();

  if (!phone || loading || !canUseWhatsAppSupport) {
    return null;
  }
