 ...
 * Solo se muestra si el coach tiene un número de teléfono configurado y el plan incluye WhatsApp
 */
export function WhatsAppButton({
  ...
  const { canUseWhatsApp, loading } = useCoachPlanFeatures();

  if (!phone || loading || !canUseWhatsApp) {
    return null;
  }
