        ...
        <div className="flex items-center gap-2 md:gap-3">
          {isAdmin && (
            <Link href="/admin-dashboard">
              <Button
                className="gap-1 md:gap-2 hover:opacity-80 transition-100 text-xs md:text-sm px-2 md:px-3"
              >
          ...
          {user && (
            <Button
              onClick={() => signOut()}
              className="flex items-center gap-1 md:gap-2 p-2 md:px-3 hover:opacity-80 transition-100"
            >
