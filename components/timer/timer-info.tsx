    ...
    switch (mode) {
      ...
      case "amrap":
        return (
          <>
            ...
            <p>• Configura múltiples rondas de AMRAP</p>
            <p>• Descanso configurable entre rondas</p>
            <p>• Ideal para entrenamientos con múltiples bloques de trabajo</p>
      ...
      case "emom":
        return (
          <>
            <p>
              • Si terminas las repeticiones antes de que termine el minuto,
              descansas lo que quede de ese minuto
            </p>
