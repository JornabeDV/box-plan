...
export default function PricingPage() {
  ...
  const handleSelectPlan = async (planId: number) => {
    ...
    try {
      const response = await fetch("/api/coaches/subscribe", {
        method: "POST",
        headers: {
      ...
      toast({
        ...
        description:
          data.message || "Tu suscripción ha sido creada exitosamente.",
      });
      ...
      <div className="bg-gradient-to-r from-primary/5 to-accent/5 py-6">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
            Elige el plan que mejor se adapte a tu negocio. Gestiona tus
            estudiantes y gana comisiones por cada suscripción.
          </p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan) => (
              <CoachPlanCard
                ...
                onRedirectToLogin={() =>
                  router.push("/login?redirect=/pricing/coaches")
                }
              />
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                Recibes un porcentaje de comisión por cada estudiante que se
                suscribe a través de tu cuenta. El porcentaje varía según tu
                plan.
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                Aceptamos todas las tarjetas de crédito y débito, transferencias
                bancarias y billeteras digitales a través de MercadoPago.
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                Puedes invitar estudiantes por email o compartir un enlace de
                invitación. Una vez que se registren y se suscriban, estarán
